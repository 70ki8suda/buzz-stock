...
import style from './FavStar.module.scss';

const FavStar = ({ FavoriteHandler, favoritedByUser, tweet, i }: any) => {
  return (
    <div
    ...
    >
      <svg version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 443.442 443.442">
        <g>
          <path
            d="M436.083,190.376l-115.52,83.927l44.13,135.801c2.388,7.353-0.236,15.403-6.479,19.954
